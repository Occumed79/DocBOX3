...
export const PRICING_SOURCES: PricingSource[] = [
  {
    ...
    name: 'FAIR Health',
    category: 'core',
    description: 'Use only a dataset or field that FAIR Health explicitly identifies as cash, self-pay, uninsured, or direct-pay.',
    coverage: 'National medical and dental coverage varies by licensed dataset.',
    eligibleLabels: ['cash', 'self-pay', 'uninsured', 'direct-pay'],
    excludedLabels: ['commercial allowed', 'claims benchmark', 'Medicare', 'Medicaid'],
    status: 'approved',
  },
  {
    id: 'turquoise-health',
    ...
    category: 'core',
    description: 'Provider-published pricing. Only discounted cash / self-pay fields are eligible for the benchmark.',
    coverage: 'National provider and facility transparency data.',
    eligibleLabels: ['discounted cash', 'cash', 'self-pay'],
    excludedLabels: ['negotiated', 'payer-specific', 'gross charge'],
    status: 'approved',
  },
  {
  ...
  },
  {
    ...
    name: 'MedCompare',
    category: 'cash-data',
    description: 'Hospital transparency data with published discounted-cash rates. Only the cash field is eligible.',
