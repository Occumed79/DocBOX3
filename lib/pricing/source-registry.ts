...
export const PRICING_SOURCES: PricingSource[] = [
  ...
  },
  {
    ...
    name: 'Loa',
    category: 'cash-data',
    description: 'Source-labeled healthcare price rows resolved to an exact local entity set. Only explicitly labeled cash, discounted-cash, or self-pay evidence is eligible.',
    coverage: 'U.S. provider/facility pricing where local entity and source-labeled cash rows are available.',
    eligibleLabels: ['cash', 'discounted cash', 'provider-verified self-pay'],
    excludedLabels: ['negotiated', 'generic MRF row without cash label', 'insurance', 'Medicare', 'Medicaid'],
    status: 'candidate',
  },
  {
    id: 'medcompare',
